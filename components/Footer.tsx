    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1 mb-8 md:mb-0">
            ...
            <p className="mt-4 text-sm">
              Achieving your financial goals with cutting-edge technology and expert strategies.
            </p>
          </div>
          ...
          <div>
            ...
            <ul>
              <li className="mb-2"><a href="#home" className="hover:text-yellow-400 transition-colors">Home</a></li>
              <li className="mb-2"><a href="#about" className="hover:text-yellow-400 transition-colors">About</a></li>
              <li className="mb-2"><a href="#services" className="hover:text-yellow-400 transition-colors">Services</a></li>
              <li className="mb-2"><a href="#robots" className="hover:text-yellow-400 transition-colors">Robots</a></li>
              <li className="mb-2"><a href="#join" className="hover:text-yellow-400 transition-colors">How to Join</a></li>
              <li className="mb-2"><a href="#" className="hover:text-yellow-400 transition-colors">Privacy Policy</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul>
              <li className="mb-2">123 Jalan Teknologi, Cyberjaya, Malaysia</li>
              <li className="mb-2">contact@silentprofit.com</li>
              <li className="mb-2">+603-1234-5678</li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Silent Profit. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
